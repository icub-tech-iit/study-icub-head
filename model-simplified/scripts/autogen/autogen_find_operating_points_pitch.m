%% Search for a specified operating point for the model - lumped_neck_with_motor.
%
...
%
% Generated on: 03-May-2022 09:34:46

%% Specify the model name
%model = 'lumped_neck_with_motor';

function [op, opreport] = autogen_find_operating_points_pitch(model, pitch_op_point, opt)
    ...
    % State (1) - lumped_neck_with_motor/Joints/Config/Solver Configuration/EVAL_KEY/INPUT_1_1_1
    % - Default model initial conditions are used to initialize optimization.
    
    % State (2) - lumped_neck_with_motor/Joints/Config/Solver Configuration/EVAL_KEY/INTERNAL_1_1_1
    % - Default model initial conditions are used to initialize optimization.
    
    % State (3) - lumped_neck_with_motor/Joints/Config/Solver Configuration/EVAL_KEY/INTERNAL_2_1_1
    % - Default model initial conditions are used to initialize optimization.
    
    % State (4) - lumped_neck_with_motor/Joints/pitch_revolute
    % - Default model initial conditions are used to initialize optimization.
    opspec.States(4).x = deg2rad(pitch_op_point);
    opspec.States(4).Known = true;
    opspec.States(4).SteadyState = false;
    opspec.States(4).dxMin = 0;
    opspec.States(4).dxMax = 0;
    
    % State (5) - lumped_neck_with_motor/Joints/pitch_revolute
    % - Default model initial conditions are used to initialize optimization.
    opspec.States(5).Known = true;
    opspec.States(5).SteadyState = false;
    
    % State (6) - lumped_neck_with_motor/Torsional Spring-Damper
    % - Default model initial conditions are used to initialize optimization.
    ...
    % State (7) - lumped_neck_with_motor/j1
    % - Default model initial conditions are used to initialize optimization.
    ...
    % Input (1) - lumped_neck_with_motor/ur
    % - Default model initial conditions are used to initialize optimization.
    ...
    % Output (1) - lumped_neck_with_motor/yp
    % - Default model initial conditions are used to initialize optimization.
